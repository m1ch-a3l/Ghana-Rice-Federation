...
export const EMAILJS_CONFIG = {
  ...
  // Primary recipient — receives every submission
  RECIPIENT_EMAIL: 'kofi@ghanarice.org',
  // Secondary recipient — also receives every submission (sent as a second request)
  RECIPIENT_EMAIL_2: 'info@ghanarice.org',
}

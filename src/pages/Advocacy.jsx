...
import millImg from '../assets/images/major-rice-mills/brazil-agro/IMG_2413.JPG'
import warehouseImg from '../assets/images/eco-warehouse/IMG_9634.JPG'
...
export default function Advocacy() {
  return (
    <>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="space-y-4 text-slate text-sm leading-relaxed mb-8">
              <p>
                The Rice Federation Ghana is the principal voice of Ghana's rice industry in engagements with government, development partners, and regional bodies. We translate industry needs into actionable policy recommendations.
              </p>
              <p>
            ...
            <div>
              <h3 className="font-mono text-gold text-xs uppercase tracking-widest mb-4">Policy Priorities 2025–2027</h3>
          ...
          <div className="relative rounded-2xl overflow-hidden" style={{ minHeight: '500px' }}>
            <img src={millImg} alt="Rice processing facility" className="absolute inset-0 w-full h-full object-cover" />
            <div className="absolute inset-0 bg-gradient-to-t from-forest/80 via-forest/20 to-transparent" />
            <div className="absolute bottom-8 left-8 right-8">
              <span className="font-mono text-gold text-xs uppercase tracking-widest block mb-2">Brazil Agro Rice Mill — Ghana</span>
              <p className="text-white/70 text-xs leading-snug">GRF advocates for investment incentives that help facilities like this modernise and expand domestic capacity.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Value Chain Actors — with warehouse image */}
      <section className="py-20 px-6 bg-cream">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <SectionLabel>Value Chain</SectionLabel>
            <h2 className="font-serif text-forest text-3xl md:text-4xl font-semibold">Actors Across the Chain</h2>
            <div className="w-14 h-0.5 bg-gold mx-auto mt-4 mb-4" />
            <p className="text-slate text-sm max-w-2xl mx-auto">
              The Rice Federation Ghana represents every actor from farm to market — coordinating their interests and amplifying their voices in policy.
            </p>
          </div>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            <div className="bg-white rounded-xl p-8 border-t-4 border-gold shadow-sm hover:shadow-md transition-shadow">
              <h3 className="font-serif text-forest text-xl font-semibold mb-3">Aggregators</h3>
              <p className="text-slate text-sm leading-relaxed mb-5">
                Aggregators play a critical role in consolidating paddy rice from smallholder farmers and ensuring a reliable supply to processing mills. They bridge the gap between scattered production and wholesale demand.
              </p>
              <ul className="space-y-2">
                {['Paddy consolidation from hundreds of small farms', 'Quality grading and sorting', 'Logistics and storage', 'Price discovery and market signaling'].map(item => (
            ...
            {/* Centre: image panel */}
            <div className="relative rounded-2xl overflow-hidden shadow-md" style={{ minHeight: '360px' }}>
              <img src={warehouseImg} alt="Rice warehouse and storage" className="absolute inset-0 w-full h-full object-cover" />
              <div className="absolute inset-0 bg-gradient-to-t from-forest/80 via-forest/30 to-transparent" />
              <div className="absolute bottom-6 left-6 right-6 text-center">
                <span className="font-mono text-gold text-xs uppercase tracking-widest block mb-2">Eco Warehouse Facility</span>
                <p className="text-white/70 text-xs">Modern storage infrastructure supported by GRF-backed investment advocacy.</p>
              </div>
            </div>

            <div className="space-y-6">
              <div className="bg-white rounded-xl p-8 border-t-4 border-gold shadow-sm hover:shadow-md transition-shadow">
                <h3 className="font-serif text-forest text-xl font-semibold mb-3">Millers &amp; Processors</h3>
                <ul className="space-y-2">
                  {['Visual quality of milled rice', 'Absence of foreign particles in milled rice', 'Broken rice content management'].map(item => (
                    <li key={item} className="flex items-start gap-2 text-sm text-slate">
                      <span className="text-gold mt-0.5 flex-shrink-0">▸</span> {item}
                    </li>
                  ))}
              ...
              <div className="bg-white rounded-xl p-8 border-t-4 border-gold shadow-sm hover:shadow-md transition-shadow">
                <h3 className="font-serif text-forest text-xl font-semibold mb-3">Distributors &amp; Logistics</h3>
                <ul className="space-y-2">
                  {['Commercial drivers deliver rice to buyers across regions', 'Most storage is done in milling house warehouses', 'Buyers typically cover delivery costs'].map(item => (
                    <li key={item} className="flex items-start gap-2 text-sm text-slate">
                      <span className="text-gold mt-0.5 flex-shrink-0">▸</span> {item}
                    </li>
                  ))}

...
const contactInfo = [
  {
    icon: MapPin,
    title: 'Accra Representative Office',
    lines: ['Rice Federation Ghana', 'No. 7 Labone Arcade', 'Opposite Zen Garden, Accra'],
  },
  {
    icon: MapPin,
    title: 'Oyarifa Warehouse',
    lines: ['Mountain View Road', 'Next to Allseasons Hotel', 'Behind Special Garden, Oyarifa'],
  },
  { icon: Phone, title: 'Phone',        lines: ['0593824667'] },
  { icon: Mail,  title: 'Email',        lines: ['info@ghanarice.org'] },
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await emailjs.send(
        ...
        { ...templateParams, recipient_email: EMAILJS_CONFIG.RECIPIENT_EMAIL },
        EMAILJS_CONFIG.PUBLIC_KEY
      )
      await emailjs.send(
        EMAILJS_CONFIG.SERVICE_ID,
        EMAILJS_CONFIG.TEMPLATE_ID,
        { ...templateParams, recipient_email: EMAILJS_CONFIG.RECIPIENT_EMAIL_2 },
        EMAILJS_CONFIG.PUBLIC_KEY
      )
      setStatus('success')
      setForm(empty)
  ...
  return (
    <>
      <PageHeader
        label="Contact Us"
        title="Get in Touch"
        subtitle="Reach out to the Rice Federation Ghana — we'd love to hear from you."
              ...
              <div className="bg-red-50 border border-red-200 rounded-xl p-5 flex items-start gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-red-500 text-xs mt-1">
                    ...
                    <a href="mailto:info@ghanarice.org" className="underline">
                      info@ghanarice.org
                    </a>
                  </p>
                  <button
